...
main;
tic;
dag_gbn=learn_struct_K2(data_trainl',node_sizes,topo_order,max_fan_in);
% dag_gbn=learn_struct_K2(data_trainl',node_sizes,order,max_fan_in);
K2_t2=toc;
fprintf('K2算法训练%d个样本%d个结点所用的时间为%d秒\n',M,N,K2_t2);
figure;
draw_graph(dag_gbn);
title('结构学习—K2算法')
